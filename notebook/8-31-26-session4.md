...
- **Commits or code:** Added `src/controllers/cmaes_policy.py`, `src/controllers/cmaes_v1.py`, `src/controllers/cmaes_v1_weights.json`, `src/racing/experiments/neuroevolution.py`, `scripts/train_cmaes.py`, `tests/test_cmaes_neuroevolution.py`, and `docs/CMAES_EXPERIMENT.md`. The controller was renamed from `cmaes_neuroevolution` to versioned name `cmaes_v1` after this experiment.
